...
Start with (1). Measure. Most resumes are 1 to 2 pages and QuestPDF renders them in tens of milliseconds; the network round-trip will dominate, and a 500 ms debounce hides it.
